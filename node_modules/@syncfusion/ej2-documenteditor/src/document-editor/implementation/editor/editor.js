...
import { protectionTypeChangeEvent, imagesProperty } from '../../base/index';
...
import { sectionsProperty, commentsProperty, bidiProperty, revisionsProperty, lastParagraphMarkCopiedProperty, sectionFormatProperty, revisionIdProperty, contextualSpacingProperty, keepWithNextProperty, keepLinesTogetherProperty, widowControlProperty, outlineLevelProperty, numberFormatProperty, startAtProperty, paragraphFormatProperty, listsProperty, abstractListsProperty, listIdProperty, listLevelNumberProperty, leftIndentProperty, rightIndentProperty, firstLineIndentProperty, textAlignmentProperty, afterSpacingProperty, beforeSpacingProperty, lineSpacingProperty, lineSpacingTypeProperty, listFormatProperty, cellsProperty, rowsProperty, blocksProperty, listLevelPatternProperty, levelsProperty } from '../../index';
...
var Editor = /** @class */ (function () {
    ...
    function Editor(documentHelper) {
       ...
       * @private
       */
        this.isFootenoteElementRemoved = false;
        /**
        * @private
        */
    ...
    */
    ...
    Editor.prototype.checkSameLevelFormat = function (lstLevelNo, abstractList, list) {
        return abstractList[levelsProperty[this.keywordIndex]][lstLevelNo][listLevelPatternProperty[this.keywordIndex]] === list[abstractListsProperty[this.keywordIndex]][levelsProperty[this.keywordIndex]][lstLevelNo][listLevelPatternProperty[this.keywordIndex]]
            && abstractList[levelsProperty[this.keywordIndex]][lstLevelNo][numberFormatProperty[this.keywordIndex]] === list[abstractListsProperty[this.keywordIndex]][levelsProperty[this.keywordIndex]][lstLevelNo][numberFormatProperty[this.keywordIndex]]
            && (abstractList[levelsProperty[this.keywordIndex]][lstLevelNo][listLevelPatternProperty[this.keywordIndex]] === (this.keywordIndex == 1 ? 10 : 'Bullet')
                || abstractList[levelsProperty[this.keywordIndex]][lstLevelNo][startAtProperty[this.keywordIndex]] === list[abstractListsProperty[this.keywordIndex]][levelsProperty[this.keywordIndex]][lstLevelNo][startAtProperty[this.keywordIndex]]);
    };
    ...
    Editor.prototype.updatePasteContent = function (pasteContent, sectionId) {
        ...
        if (pasteContent[listsProperty[this.keywordIndex]].filter(function (obj) { return obj.listId === uniqueListId; }).length > 0) {
        ...
        var _loop_1 = function (k) {
            ...
            if (!isNullOrUndefined(abstractList)) {
                var isUpdate = this_1.updateListIdForBlocks(pasteContent[sectionsProperty[this_1.keywordIndex]][sectionId][blocksProperty[this_1.keywordIndex]], abstractList, lstDup[0], list.listId, uniqueListId);
                if (isUpdate) {
    ...
    Editor.prototype.getBlocks = function (pasteContent, isPaste, sections, comments, revision) {
        ...
        if (typeof (pasteContent) === 'string') {
            ...
            for (var i = 0; i < pasteContent[sectionsProperty[this.keywordIndex]].length; i++) {
                ...
                parser.parseBody(pasteContent[sectionsProperty[this.keywordIndex]][i][blocksProperty[this.keywordIndex]], bodyWidget.childWidgets);
    ...
    Editor.prototype.reLayout = function (selection, isSelectionChanged, isLayoutChanged) {
        ...
        if (selection.owner.isShiftingEnabled) {
            ...
            if (((!isNullOrUndefined(bodyWidget.nextRenderedWidget) && bodyWidget.nextRenderedWidget.sectionFormat.breakCode === 'NoBreak') || (bodyWidget.sectionFormat.breakCode === 'NoBreak' && (bodyWidget.sectionIndex === bodyWidget.page.bodyWidgets[0].sectionIndex) && bodyWidget.sectionFormat.numberOfColumns > 1)) && !(bodyWidget instanceof HeaderFooterWidget) && !(!isNullOrUndefined(bodyWidget.containerWidget) && bodyWidget.containerWidget instanceof FootNoteWidget)) {
    ...
    Editor.prototype.updateHeaderFooterWidgetToPageInternal = function (page, widget, isHeader) {
        var update = false;
        if (isHeader) {
            update = widget != page.headerWidgetIn && widget.page.headerWidgetIn.parentHeaderFooter == page.headerWidgetIn.parentHeaderFooter;
        }
        else {
            update = widget != page.footerWidgetIn && widget.page.footerWidgetIn.parentHeaderFooter == page.footerWidgetIn.parentHeaderFooter;
        }
        if (update) {
        ...
        if (element.paragraph.bodyWidget.page.footnoteWidget) {
            ...
            for (var j = 0; j < footnoteWidget.bodyWidgets.length; j++) {
                if (element === (footnoteWidget.bodyWidgets[j]).footNoteReference) {
                    ...
                    j--;
                    this.isFootenoteElementRemoved = true;
                }
            }
